    ...
    <table class="padd-left">
		<tr style="">
				...
				<table class="itinerary">
					...
					<tr>
						...
						<td style="padding-bottom:10px;vertical-align:top;line-height:20px;">
							<span><b><?php echo e($itineraryValue->description); ?></b></span>
						</td><br /><br />
					</tr>
					<?php endforeach; ?>	
				</table>
            ...
            <td style="width:40%;text-align:right;">
                ...
                <img src="<?php echo e(url('/')); ?>/<?php echo trim($itineraryImage->image); ?>" alt="" title="" style="width:220px;height:140px;" /><br />
				<?php endforeach; ?>               
            </td>
		</tr>
    </table>
