	                        ...
	                        @foreach($user as $row)
	                            <div class="card-header" data-background-color="purple">	
	                            	<div class="row">
	                            		...
	                            		<div class="col-md-3"> 
	                            		<a href="{{ url('/useredit') }}/<?php echo $row->id; ?>" title="Edit Profile"><i class="material-icons edit-icon">border_color</i></a>
	                            		</div>
	                            	</div>
	                            </div>
	                            <div class="card-content">
	                            	<div class="row">
	                            		...
	                            		<div class="col-md-9 view-profile">
											<ul>
												<li><i class="material-icons">person</i>{{$row->name}}</li>
