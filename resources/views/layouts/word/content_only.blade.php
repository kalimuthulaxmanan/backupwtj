...
<td width=539>
<p style="font-size: 14px;">{!!nl2br($data->content)!!}</p>
</td>
</tr>
</table>
</div>	
  ...
  <table id='hrdftrtbl' border='0' cellspacing='0' cellpadding='0'>
    <tr>
    <td>
    <div style='mso-element:footer' id="cf1"><span style='position:relative;z-index:-1'> 
       <img src="{{url('/')}}/{{$data->upload_path}}/<?php echo trim($data->logo); ?>" alt="" title="" width="150" height="50" />
        ...
        <div style='mso-element:footer' id="fcf1">
        <p class='MsoFooter'></p>
    </div>
