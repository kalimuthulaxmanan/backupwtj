	            ...
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="col-md-12">
	                        ...
	                        <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('addsuccess') }}</p>
							@endif
							</div>
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-6">
												<div class="form-group label-floating{{ $errors->has('username') ? ' has-error' : '' }}">
													...
													<input type="text" title="Please enter you userName" required="" class="form-control" name="username" value="{{ old('username') }}">
