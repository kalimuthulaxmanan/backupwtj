                            ...
                            <div class="card">
                               <!-- <div class="card-header" data-background-color="purple">
                                ...
                                <div class="card-content table-responsive">
									...
									<a href="<?php echo e(url('/download')); ?>/<?php echo e($fileid); ?>.pdf"> <button  <?php if (!(file_exists($file_path))){ echo 'disabled';} ?> type="button" class="btn btn-primary ">PDF</button></a>	
									...
									<a href="<?php echo e(url('/pdflist')); ?>"> <button type="button" class="btn btn-primary ">Back</button></a>
									<div class="container">
                ...
                <div class="tab-content">
                  ...
                  <div id="menu1" class="tab-pane fade in active">
                   <div class="modal-body edit-image">
                        ...
                        <input type="radio" id="<?php echo e($gallery->id); ?>" name="myRadio"/>
                        <label for="<?php echo e($gallery->id); ?>">
						<img id="imageid<?php echo e($gallery->id); ?>" src="<?php echo e(url('/')); ?>/<?php echo trim($gallery->image);?>" />
                        </label>
                        <?php endforeach; ?>
