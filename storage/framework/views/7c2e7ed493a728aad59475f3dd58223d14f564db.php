    ...
    <table style="width: 100%;">
		<tr>
            <td style="padding-left:15px;">
                ...
                <h1 style="font-size:40px;font-weight: 700px !important;line-height: 40px;margin-top: 10px;color:#000"><?php echo ucfirst(strtolower(mb_substr($data->title, 0,55))); ?></h1><br /><br />
            </td>
		</tr>
	</table>
    <table style="width: 100%;">
