	            ...
	            <div class="card">
	                <div class="card-header" data-background-color="purple">
                        <div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                    <a href="<?php echo e(url('/viewprofile')); ?>" title="Back"><i class="fa fa-arrow-left profileedit"  aria-hidden="true"></i></a>
                                    </div>
                        </div>
	                </div>
	                <div class="card-content">
	                    <form method="POST" action="<?php echo e(url('/updateprofile')); ?>/<?php echo e($id); ?>" enctype="multipart/form-data" onsubmit="return check()" id="editform">
	                    	<?php echo csrf_field(); ?>
                    	...
                    	<div class="row">
                            <div class="col-md-6">
								...
								<input type="text" title="Please enter you firstName" class="form-control" name="firstname" value="<?php echo e($row->firstName); ?>" id="firstname">
                            ...
                            <div class="col-md-6">
								...
								<input type="text" title="Please enter you lastName" class="form-control" name="lastname" value="<?php echo e($row->lastName); ?>" id="lastname">
                        ...
                        <div class="row">
                        	<div class="col-md-6">
								<div class="form-group label-floating<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
									...
									<input type="text"  title="Please enter you email" class="form-control" name="email" value="<?php echo e($row->email); ?>" id="email" onblur="emailcheck()">
                            ...
                            <div class="col-md-6">
								<div class="form-group label-floating<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
									...
									<input type="text" title="Please enter you Phone Number" class="form-control" name="phone" value="<?php echo e($row->phone); ?>" id="phone" onblur="emailcheck()">
                        ...
                        <div class="row">
                            <div class="col-md-12">
								<div class="form-group label-floating<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
									...
									<input type="text" title="Please enter you Address" class="form-control" name="address" value="<?php echo e($row->address); ?>" id="address">
                        ...
                        <div class="row">
                            <div class="col-md-6">
								<div class="form-group label-floating<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
									...
									<input type="text" title="Please enter you City" class="form-control" name="city" value="<?php echo e($row->city); ?>" id="city">
                            ...
                            <div class="col-md-6">
								<div class="form-group label-floating<?php echo e($errors->has('country') ? ' has-error' : ''); ?>">
									...
									<input type="text" title="Please enter you Country" class="form-control" name="country" value="<?php echo e($row->country); ?>" id="country">
