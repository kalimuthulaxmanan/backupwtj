...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(url('assets/css/custom-stylehtml.css')); ?>" />
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar" data-color="purple" data-image="<?php echo e(url('/assets/img/sidebar-1.jpg')); ?>">
            <!--
            ...
            <div class="logo">
                <a href="<?php echo e(url('/dashboard')); ?>" class="simple-text">
                    <img width="200px" src="<?php echo e(url('/images/logo.png')); ?>">
                </a>
            </div>
            ...
            <div class="sidebar-wrapper">
                <ul class="nav collapsible">
                    <li >
                        <a class="collapsible-header" href="<?php echo e(url('/dashboard')); ?>">
                    ...
                    <li <?php echo (strpos($currentUrl,'pdflist')!=0)?'class="Active"':''; ?> <?php echo (strpos($currentUrl,'generateHtmlPreview')!=0)?'class="Active"':''; ?>>
                        <a  class="collapsible-header"  href="<?php echo e(url('/pdflist')); ?>">
					...
					<li>
                     <a  class="collapsible-header"  href="<?php echo e(url('/form')); ?>">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo e(url('/viewprofile')); ?>"><i class="material-icons">account_box</i>View Profile</a></li>
                                    
                                    <li><a href="<?php echo e(url('/changepassword')); ?>"><i class="material-icons">vpn_key</i>Change Password</a></li>
                                    <li>
    ...
    <!--   Core JS Files   -->
    <script src="<?php echo e(url('/assets/js/jquery-3.1.0.min.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(url('/assets/js/material.js')); ?>" type="text/javascript"></script>
    ...
    <script src="<?php echo e(url('/assets/js/according.js')); ?>"></script>
		<link rel="stylesheet" type="text/css" href="<?php echo e(url('/css/dataTables.material.css')); ?>">


	<script type="text/javascript" language="javascript" src="<?php echo e(url('/js/jquery.dataTables.js')); ?>">
	</script>
