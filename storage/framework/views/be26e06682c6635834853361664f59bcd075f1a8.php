                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    <?php endif; ?>
                                      <table   class="mdl-data-table table" cellspacing="0" width="100%">
                                        ...
                                        <tbody class="tbodypad">
                                            ...
                                            <tr>
                                                ...
                                                echo date_format($date,"M-d-Y h:i:sa"); ?></td>
												...
												<a <?php if ($file->flip_book_name!=1){ echo 'disabled';} ?> style="padding:10px 10px;" class="btn btn-primary btn-simple" rel="tooltip" data-original-title="<?php if($file->flip_book_name==NULL){echo 'Click left icon to generate flip book'; } elseif($file->flip_book_name==1){echo 'Flip Book';} elseif($file->pdf_name==0){echo 'contents exist page size so Unable to generate flipbook';} ?>" href="<?php echo e(url('/flipbook')); ?>/<?php echo e(base64_encode($file->id)); ?>" target="_blank"><i class="fa fa-book" aria-hidden="true"></i></a>
												<input type="hidden" name="flip_url" id="<?php echo e($file->id); ?>" value ="<?php echo e(url('/flipbook')); ?>/<?php echo e(base64_encode($file->id)); ?>" />
												<a <?php if ($file->flip_book_name!=1){ echo 'disabled';} ?> style="padding:10px 10px;" class="btn btn-primary btn-simple" rel="tooltip" data-original-title="Click & Copy Flip Book Link" s><i class="fa fa-link" onClick="copyToClipboard('#<?php echo e($file->id); ?>')" aria-hidden="true"></i></a>	
