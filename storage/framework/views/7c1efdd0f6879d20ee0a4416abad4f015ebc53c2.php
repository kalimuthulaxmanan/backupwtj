	            ...
	            <div class="card">
	                <div class="card-header" data-background-color="purple">
	                    <div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                    <a href="<?php echo e(url('/userlist')); ?>" title="Back"><i class="fa fa-arrow-left edit"  aria-hidden="true"></i></a>
                                    </div>
                        </div>
	                </div>
	                <div class="card-content">
	                    <form method="POST" action="<?php echo e(url('/updateuser')); ?>/<?php echo e($id); ?>" enctype="multipart/form-data" onsubmit="return check()" id="editform">
	                    	<?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
								<div class="form-group label-floating<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
									...
									<input type="text" title="Please enter you Phone Number" class="form-control" name="phone" value="<?php echo e($row->phone); ?>" id="phone" onblur="phonecheck()">
