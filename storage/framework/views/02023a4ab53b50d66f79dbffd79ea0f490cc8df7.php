	                ...
	                <div class="row">
	                    <div class="col-md-offset-2 col-md-8">
	                        <div class="card">
	                            ...
	                            <form method="POST" action="<?php echo e(url('/savepassword')); ?>" onsubmit="return check()">
	                                	<?php echo csrf_field(); ?>

	                                	
	                                	<?php if(Session::has('passwordfail')): ?>
		                              <body onload="demo.showNotification('top','center',4,'Current Password Cannot Match')"/>
		                            <?php endif; ?>

		                            <?php if(Session::has('passwordpass')): ?>
		                              <body onload="demo.showNotification('top','center',2,'Password Changed Successfully')"/>
		                                <?php endif; ?>
	                                    <div class="row">
	                                        <div class="col-md-12">
												<div class="form-group label-floating<?php echo e($errors->has('current_password') ? ' has-error' : ''); ?>">
