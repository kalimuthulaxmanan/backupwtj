	            ...
	            <div class="card">
	                <div class="card-header" data-background-color="purple">
                        <div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                    <a href="{{ url('/viewprofile')}}" title="Back"><i class="fa fa-arrow-left profileedit"  aria-hidden="true"></i></a>
                                    </div>
                        </div>
	                </div>
	                <div class="card-content">
	                    <form method="POST" action="{{ url('/updateprofile')}}/{{$id}}" enctype="multipart/form-data" onsubmit="return check()" id="editform">
	                    	{!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
								<div class="form-group label-floating{{ $errors->has('phone') ? ' has-error' : '' }}">
									...
									<input type="text" title="Please enter you Phone Number" class="form-control" name="phone" value="{{$row->phone}}" id="phone" onblur="emailcheck()">
