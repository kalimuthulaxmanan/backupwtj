...
<style type="text/css">
    ...
    <div style="width: 100%;" class="index-image">
        ...
        <img src="<?php echo e(url('/')); ?>/<?php echo e($data->upload_path); ?>/<?php echo trim($data->signature); ?>" alt="" title="" style="width:150px;height:50px;position:absolute;top:440px;left:10px;" />
	<?php endforeach; ?>
    </div>
		...
		<tr style="">
            <td style="width:50%;vertical-align:bottom">
                <?php if(trim($data->additional_logo)!=""): ?>
                    <img src="<?php echo e(url('/')); ?>/<?php echo $data->upload_path; ?><?php echo trim($data->additional_logo); ?>" alt="" title="" style="width:150px;height:50px;margin-bottom:15px;"/>
                <?php endif; ?>
