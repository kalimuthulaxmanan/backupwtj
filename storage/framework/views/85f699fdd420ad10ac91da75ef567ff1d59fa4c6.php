	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
								...
								<div class="row">
                                    ...
                                    <div class="col-md-3"> 
                                    <a href="<?php echo e(url('/userlist')); ?>" title="List User"><i class="fa fa-list listuser"  aria-hidden="true"></i></a>
                                    </div>
                                </div>	
	                            </div>
	                            <div class="card-content">
	                                <form method="POST" action="<?php echo e(url('/adduser')); ?>" enctype="multipart/form-data" onsubmit="return check()">
	                                <?php echo csrf_field(); ?>
	                                ...
	                                <?php endif; ?>
	                                	<div class="row">
	                                        <div class="col-md-6">
												...
												<input type="text" title="Please enter you firstName" class="form-control" name="firstname" value="<?php echo e(old('firstname')); ?>" id="firstname">
	                                        ...
	                                        <div class="col-md-6">
												...
												<input type="text" title="Please enter you lastName" class="form-control" name="lastname" id="lastname" value="<?php echo e(old('lastname')); ?>">
	                                    ...
	                                    <div class="row">
	                                    	<div class="col-md-6">
												<div class="form-group label-floating<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
													...
													<input type="text"  title="Please enter you email" class="form-control" name="email" id="email" value="<?php echo e(old('email')); ?>" onblur="emailcheck()">
	                                        ...
	                                        <div class="col-md-6">
												<div class="form-group label-floating<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
													...
													<input type="text" title="Please enter you phone number"  class="form-control" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" onblur="phonecheck()">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-12">
												<div class="form-group label-floating<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
													...
													<input type="text" title="Please enter you Address" class="form-control" name="address" id="address" value="<?php echo e(old('address')); ?>">
	                                    ...
	                                    <div class="row">
	                                        <div class="col-md-6">
												<div class="form-group label-floating<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
													...
													<input type="text" title="Please enter you City" class="form-control" name="city" id="city" value="<?php echo e(old('city')); ?>">
	                                        ...
	                                        <div class="col-md-6">
												<div class="form-group label-floating<?php echo e($errors->has('country') ? ' has-error' : ''); ?>">
													...
													<input type="text" title="Please enter you Country" class="form-control" name="country" id="country" value="<?php echo e(old('country')); ?>">
