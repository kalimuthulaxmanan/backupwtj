    ...
    <table style="width: 100%;">
		<tr>
            <td style="padding-left:15px;">
				<p style="margin-top:22px;"><b style="font-weight:800;font-size:15px;color:#000"><?php echo e($data->itinerary_date_with_title); ?></b></p>
                <h1 style="font-size:50px;font-weight: 800px !important;"><?php echo e($data->title); ?></h1><br /><br />
            </td>
		</tr>
	</table>
    <table style="width: 100%;">
		<tr style="">
            <td style="width:30%;vertical-align:top;padding-top:8px;padding-left:15px;">  
                ...
                <img src="<?php echo e(url('/')); ?>/<?php echo trim($contentImage->image); ?>" alt="" title=""  style="width:225px;height:150px" /><br /><br />
                <?php endforeach; ?>
            </td>
